...
from utils.utils import AverageMeter, progress_bar, accuracy

parser = argparse.ArgumentParser(description='PyTorch CIFAR10 Training')
parser.add_argument('--model', default='vgg16_bn', type=str, help='name of the model to test')
parser.add_argument('--checkpoint', default=None, type=str, help='path of model checkpoint')
